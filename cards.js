...
const indexSectionSection = document.querySelectorAll('.Radiologia img');
...
const accordionButtons = document.querySelectorAll('.accordion-button2');
const accordionButtons = document.querySelectorAll('.accordion-button3');
